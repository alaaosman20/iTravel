 ...
 */
public class PhotoExifActivity extends Activity implements GeocodeSearch.OnGeocodeSearchListener {
    ...
    private String TAG = PhotoExifActivity.class.getSimpleName();
...
//            latLng = new LatLng(currentLat, currentLon);
        ...
        // 反地理编码
        geocoderSearch = new GeocodeSearch(PhotoExifActivity.this);
        geocoderSearch.setOnGeocodeSearchListener(PhotoExifActivity.this);
